...
#Create an infinite loop which will produce the live feed to our desktop and that will search for hands
    while True:
        ...
        if(pos_dict[0] and pos_dict[8] and pos_dict[12] and pos_dict[16] and pos_dict[20]):
            ...
            if(abs(pos_dict[8][1] - pos_dict[0][1]) > height/2 and abs(pos_dict[12][1] - pos_dict[0][1]) > height/2 and abs(pos_dict[20][1] - pos_dict[0][1]) < height/2 and abs(pos_dict[16][1] - pos_dict[0][1]) < height/2 and pos_dict[8][0] - pos_dict[12][0] < 20):
                print("do something")
