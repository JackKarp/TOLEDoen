...
#Create an infinite loop which will produce the live feed to our desktop and that will search for hands
    while True:
        ...
        if(pos_dict[0] and pos_dict[8] and pos_dict[12] and pos_dict[16] and pos_dict[20]):
            ...
            up_dict = {0:False,4:False,8:abs(pos_dict[8][1] - pos_dict[0][1]) > height/2,  12:abs(pos_dict[12][1] - pos_dict[0][1]) > height/2,  16:abs(pos_dict[16][1] - pos_dict[0][1]) > height/2,  20:abs(pos_dict[20][1] - pos_dict[0][1]) > height/2}
            # for i in range(0,21,4):  # Debugging
            #     print(up_dict[i])
